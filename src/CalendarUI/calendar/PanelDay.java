...
public class PanelDay extends DynamicCell<ModelDate> {
    ...
    private Date addDate(ModelDate date, int values) {
        ...
        calendar.set(java.util.Calendar.MONTH, date.getMonth() - 1);
        calendar.set(java.util.Calendar.DATE, date.getDay());
        calendar.add(java.util.Calendar.DATE, values);
        return calendar.getTime();
    }

    private ModelDate getDisplayDate(ModelMonth month) {
        java.util.Calendar calendar = java.util.Calendar.getInstance();
        calendar.set(java.util.Calendar.YEAR, month.getYear());
        calendar.set(java.util.Calendar.MONTH, month.getMonth() - 1);
        calendar.set(java.util.Calendar.DATE, 1);
        int m = calendar.get(java.util.Calendar.DAY_OF_WEEK) - 1;
        calendar.set(java.util.Calendar.DATE, -(m + 6));
